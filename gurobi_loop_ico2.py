...
ARQUIVO = "01_base_dados_modelo_ICO2.csv"
...
def otimizar_com_gurobi(k):
    ...
    modelo = gp.Model(f"index_tracking_ICO2_k_{k}")
...
print("\n====================================")
print("RANKING FINAL - GUROBI ICO2")
print("====================================")
print(resultados_df)
...
nome_excel = "resultado_gurobi_loop_ICO2.xlsx"
...
plt.title("Retorno acumulado: Gurobi ICO2 vs Ibovespa")
plt.xlabel("Data")
...
nome_grafico = "grafico_gurobi_loop_ICO2.png"
